...
# C#成员函数在Lua中的调用
还是以[UnityEngine.GameObject]](https://docs.unity3d.com/2021.3/Documentation/ScriptReference/GameObject.html)为例如下成员函数
...
以上长远函数属于GameObject类型的实例化对象。 必须要先拿到或者创建对象实例后才能调用。**注意成员函数用":"号调用。**
```Lua
function Start()
