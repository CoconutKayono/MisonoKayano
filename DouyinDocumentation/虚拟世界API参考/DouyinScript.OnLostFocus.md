function OnLostFocus(HandType hand)
# 参数
| 参数  | 参数描述 |
| --- | --- |
| hand  | 玩家按压屏幕的区域 |
...
焦点丢失。
# 代码示例
当调用DouyinScipt.DisableInteraction()方法时，会触发DouyinScipt.OnLostFocus方法。开发者可以在这里移除交互按钮，可参考DouyinPickup.lua和DouyinSeat.lua文件。
```Lua
