public void StandUp(GameObject go)
# 参数
| 参数 | 参数描述 |
| --- | --- |
| go | 指定的从哪个座位站起 |
...
# 代码示例
执行StandUp方法，并不会真正执行坐下操作，需要开发者实现坐下逻辑。当调用DouyinActor.StandUp从A物体上站起时，会找到A物体上的DouyinScript脚本，然后执行A物体上的OnSeatExited方法，开发者需要在OnSeatExited方法中，实现玩家从物体上站起的逻辑。以下是相关功能的实现Demo，您也可以参考官方的DouyinSeat.lua脚本，去实现自己想要的功能。
```Lua
