...
Physical Camera 属性让 URP Camera 模拟真实相机。这些属性对应真实相机的功能，并以相同方式工作。有关如何使用这些属性创建所需 Camera effect 的信息，请参阅[[../../08-使用物理相机模拟真实相机/00-使用物理相机模拟真实相机|使用物理相机模拟真实相机]]。
...
| **Gate Fit** | 更改 resolution gate（Game view 的大小/aspect ratio）相对于 film gate（Physical Camera sensor 的大小/aspect ratio）的尺寸。可选 **Vertical**、**Horizontal**、**Fill**、**Overscan** 和 **None**，具体含义参阅 [Gate Fit 简介](../../08-使用物理相机模拟真实相机/03-使用%20Gate%20Fit%20裁剪或拉伸视图/01-Gate%20Fit%20简介.md)。 |
...
- 下一页：[[../../11-Built-In Render Pipeline中的相机/00-Built-In Render Pipeline中的相机]]
