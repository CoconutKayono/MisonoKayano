...
![Mesh Renderer 的 Occlusion Culling 窗口](图片/OcclusionCullingInspectorObject.png)
...
![Occlusion Culling Inspector 的 Bake 选项卡](图片/OcclusionCullingInspectorBake.png)
...
- 目录：[[00-使用遮挡剔除排除隐藏对象]]
- 下一页：[[08-CullingGroup API/00-CullingGroup API]]
