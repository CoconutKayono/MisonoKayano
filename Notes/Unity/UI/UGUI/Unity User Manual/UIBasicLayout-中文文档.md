...
![工具栏中的 Rect Tool](GUI_Rect_Tool_Button.png)
...
![Pivot 与 Local 工具栏设置](GUI_Pivot_Local_Buttons.png)

## Rect Transform

Rect Transform 是用于所有 UI 元素的新型 Transform 组件，替代普通的 Transform 组件。

![Rect Transform 检查器](UI_RectTransform.png)
...
![调整 UI 轴心与旋转](UI_PivotRotate.png)
...
![Anchor Presets 面板](UI_AnchorPreset.png)
