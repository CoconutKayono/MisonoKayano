...
- [[../01-通用渲染管线基础知识/02-URP 中的渲染路径/06-URP 中的 Forward+ 渲染路径的故障排除]]
...
![打开项目设置 (Project Settings) > 质量 (Quality) > 渲染管线资产 (Render Pipeline Asset)，选择 SamplesPipelineAsset](图片/urp-12-package-samples.png)
...
![分配了渲染器功能的 UniversalRenderer。](图片/urp-10-renaming-renderer.png)
...
- 上一页：[[04-升级 URP/18-从轻量级渲染管线升级到通用渲染管线]]
- 目录：[[00-安装和升级 URP]]
