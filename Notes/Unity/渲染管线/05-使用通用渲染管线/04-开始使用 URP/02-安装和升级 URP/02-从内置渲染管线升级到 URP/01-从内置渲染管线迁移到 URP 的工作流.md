...
You must have an existing project that uses the Built-In Render Pipeline. If you don’t have an existing project, refer to [[../01-创建 URP 项目/01-使用 URP 创建新项目]] instead.
...
有关更多信息，请参阅[[../../../../03-选择渲染管线/02-渲染管线功能比较参考]]。
...
要了解 URP 中的渲染方式，请参阅[[../../01-通用渲染管线基础知识/01-通用渲染管线中的渲染]]和[[../../../07-在 URP 中自定义渲染和后期处理/00-在 URP 中自定义渲染和后期处理]]。
