...
| **Pixel Light Count** | 在 URP 中，每个对象的最大实时光源数量取决于所使用的渲染路径。有关更多信息，请参阅 [[../../01-通用渲染管线基础知识/02-URP 中的渲染路径/01-URP 中渲染路径简介]]。<br><br>要设置每个对象的光源数量，请使用 **URP 资源 (URP Asset)** > **光照 (Lighting)** > **其他光源 (Additional Lights)** > **每像素 (Per Pixel)** > **每对象限制 (Per Object Limit)**。 |
...
- [[../../../08-通用渲染管线参考/01-URP 通用渲染管线资源参考.md]]
...
- 下一页：[[../03-从 HDRP 迁移到 URP/00-从 HDRP 迁移到 URP]]
