...
![Transform Component](图片/TransformExample4.png)
...
![显示颜色编码坐标轴的 Transform](图片/TransformExample2.png)
...
![Hand、Move、Rotate 和 Scale 工具](图片/Transform-Tools.png)

你可以对 Scene 中的任意 GameObject 使用 Transform 工具。选择 GameObject 时，Transform 内会显示工具 Gizmo。Gizmo 的外观取决于你选择的工具。

![带有键盘快捷键提示的 Transform Gizmo](图片/TransformGizmo35.png)
...
![Hierarchy 窗口中的父子 GameObject：Child 1 和 Child 2 属于 Parent，Child 3 属于 Child 2 并且是 Parent 的后代](图片/parenting-in-hierarchy-window.png)
