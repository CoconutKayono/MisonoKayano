...
![Inspector 将 Dictionary 字段显示为两列列表，左侧为键、右侧为值。](图片/serialization-dictionary-inspector.png)
...
![Inspector 将 dictionary field 显示为两列 list，左侧为 keys，右侧为 values。](图片/serialization-dictionary-inspector.png)
