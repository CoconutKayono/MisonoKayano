...
![Vector 减法示意图](图片/VectorSubtract.png)
...
![不同角度的 Dot product 值](图片/DotProduct.png)

![余弦值与 Vector 夹角的关系](图片/CosineValues.png)
...
![正弦值与 Vector 夹角的关系](图片/SineValues.png)
...
![根据三角形三个点计算法线](图片/CalculateNormal.png)
...
![使用左手规则确定 Cross product 输入顺序](图片/LeftHandRuleDiagram.png)
