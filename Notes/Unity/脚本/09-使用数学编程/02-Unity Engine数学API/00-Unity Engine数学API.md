...
| 页面 | 说明 |
| --- | --- |
| [[01-使用Mathf进行常见数学运算]] | 使用 Unity 的 [`Mathf`](https://docs.unity3d.com/6000.7/Documentation/ScriptReference/Mathf.html) 类，执行游戏开发中常用的三角函数、对数函数和其他数学函数。 |
| [[02-使用Vector类移动对象]] | 使用 Unity 的 2D、3D 和 4D Vector 类执行 Vector 运算，以管理对象的位置和速度，以及对象之间的距离。 |
| [[03-使用Random类生成随机数]] | 使用 [`Random`](https://docs.unity3d.com/6000.7/Documentation/ScriptReference/Random.html) 类生成游戏开发中常用的各种随机值。 |
| [[04-使用Quaternion控制旋转]] | 在 Unity 的左手坐标系中使用 Euler 角或 Quaternion，控制 GameObject 的旋转和朝向。 |
