...
![倾斜的 View Frustum：底部一侧与 Camera center line 的夹角小于顶部一侧](ObliqueFrustum.png)
...
![使用 Lens Shift 使对称的 Frustum 变为 oblique](Unity/Unity%20Manual%20中文文档/Camera/03-相机视图/图片/ObliqueFrustum_LensShift.png)

有关 Physical Camera 选项的更多信息，请参阅[[00-使用物理相机模拟真实相机]]。
...
- [[00-Camera Inspector窗口参考]]
- [[02-Camera Inspector窗口参考]]
