...
Camera Stack 可以合成多台 Camera 的结果，由一台 Base Camera 和任意数量的 Overlay Camera 组成。使用 Stack 属性将 Overlay Camera 添加到 Stack，它们会按 Stack 中定义的顺序渲染。有关配置和使用 Camera Stack 的更多信息，请参阅[[02-设置Camera Stack|设置 Camera Stack]]。
