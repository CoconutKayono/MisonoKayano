...
![Gate Fit 设置为 Vertical：裁剪图像两侧](GateFitV_600x900_16mm.png)

当 sensor aspect ratio 小于 Game view aspect ratio 时，Unity 会在两侧对 rendered image 执行 overscan：

![Gate Fit 设置为 Vertical：在两侧 overscan 图像](GateFitV_16-9_16mm.png)
...
![Gate Fit 设置为 Horizontal：在顶部和底部 overscan 图像](GateFitH_600x900_16mm.png)

当 sensor aspect ratio 小于 Game view aspect ratio 时，Unity 会裁剪 rendered image 的顶部和底部。

![Gate Fit 设置为 Horizontal：裁剪图像顶部和底部](GateFitH_16-9_16mm.png)
...
![没有 Gate Fit：将图像拉伸到不同的 Game view](GateFitF_16mm.png)
