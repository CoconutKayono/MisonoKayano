...
![Resolution gate 与 film gate](Unity/Unity%20Manual%20中文文档/Camera/08-使用物理相机模拟真实相机/图片/GateFitGates.png)
...
![Resolution gate 与 film gate 的位置](Unity/Unity%20Manual%20中文文档/Camera/08-使用物理相机模拟真实相机/图片/GateFitUI.png)
