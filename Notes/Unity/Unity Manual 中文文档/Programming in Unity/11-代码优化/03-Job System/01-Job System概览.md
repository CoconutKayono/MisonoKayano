...
除了 Unity 核心引擎提供的 Job System 之外，Collections package 还扩展了许多 [Job 类型](02-Jobs概览.md)和[Native Container](00-线程安全类型.md)。更多信息请参阅 [Collections 文档](https://docs.unity3d.com/Packages/com.unity.collections@latest/)。
