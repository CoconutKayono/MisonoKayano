...
| 页面 | 说明 |
| --- | --- |
| [[04-TransformHandle类参考]] | 介绍 [`TransformHandle`](https://docs.unity3d.com/6000.7/Documentation/ScriptReference/TransformHandle.html) API，以及它与 [`Transform`](https://docs.unity3d.com/6000.7/Documentation/ScriptReference/Transform.html) API 的主要差异。 |
| [[02-TransformHandle API代码示例]] | 展示 `Transform` 与 `TransformHandle` API 差异的代码示例。 |
| [[03-在Burst中使用TransformHandle]] | 介绍与 [Burst](https://docs.unity3d.com/Packages/com.unity.burst@latest) 编译器完全兼容的 `TransformHandle` API，以及如何借此优化代码。 |
