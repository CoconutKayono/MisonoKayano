...
![Test Runner 窗口，其中选中了 Player Tab，并显示可以在 Player 中运行的 Play Mode 测试列表。](run-playmode-standalone.png)
...
![构建出的 Player 显示在其上运行的 Play Mode 测试结果。](playmode-results-standalone.png)
...
![Test Runner 窗口中的下拉选择器，显示在不运行测试的情况下将全部测试或选定测试构建到 Player 的选项。](playmode-standalone-build-tests.png)
...
![Test Runner 窗口中的下拉选择器，显示将全部测试或选定测试导出到 Player 的选项。](playmode-standalone-build-tests-android-ios.png)
