...
![Console 窗口显示三种调试消息：带白色感叹号图标的普通日志、带黄色感叹号图标的警告，以及带红色感叹号图标的错误。](ConsoleShowingMessageWarningAndError.png)
...
![Console 窗口将 I come in peace! 显示为警告级别的日志消息。](ConsoleMessageWithContextGameObject.png)
...
![Scene 视图显示一组 Sphere，每个 Sphere 都有一条洋红色线条，表示它与 Y 等于零的平面之间的距离。](DebugDrawLineExampleInScene.png)
