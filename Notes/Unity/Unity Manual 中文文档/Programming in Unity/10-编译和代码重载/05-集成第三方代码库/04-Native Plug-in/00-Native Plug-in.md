...
| [[00-调用函数]] | 如何从 Managed C# Code 调用 Native Plug-in 中的 Unmanaged Function，以及如何从 Unmanaged Code 回调 Managed Code。 |
| [[00-传递数据]] | 如何在 Managed Code 与 Unmanaged Code 之间交换数据。 |
