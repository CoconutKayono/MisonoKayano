...
![Assembly Definition importer Inspector 窗口中的 Name 和 General 部分](name-and-general.png)
...
![Assembly Definition importer Inspector 窗口中的 Assembly Definition References 和 Assembly References 部分](assembly-ref.png)
...
![Assembly Definition importer Inspector 窗口中选中 Any Platform 的 Platforms 部分](platforms.png)
...
![Assembly Definition importer Inspector 窗口的 Define Constraints 部分，其中一个约束被标记为当前未满足](define-constraints.png)
...
![Assembly Definition importer Inspector 窗口中的 Version Defines 部分，其中为 Unity Test Framework 和 VS Code Package 的特定版本配置了定义](version-defines.png)
