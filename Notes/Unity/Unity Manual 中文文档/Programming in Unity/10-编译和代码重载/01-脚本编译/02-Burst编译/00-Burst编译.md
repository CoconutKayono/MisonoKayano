...
| [[00-CSharp语言支持]] | 了解 Burst 可以编译的高性能 C# 子集中的语言元素。 |
| [[00-配置Burst编译]] | 定义 Burst 在不同上下文中编译什么以及如何编译，标记代码进行 Burst 编译，并配置编译过程的各个方面。 |
| [[00-Burst Intrinsics]] | 如果正在编写 single instruction, multiple data（SIMD）汇编代码，使用低级 intrinsics 从 Burst 获得额外性能。 |
...
| [[00-Burst优化]] | 调试和分析 Burst 编译的代码以查找错误或瓶颈，并配置一系列选项来优化性能。 |
