...
- **Job**：将 `[BurstCompile]` 应用到 Job 定义时，Burst 会编译 Job 内部的所有内容。有关 Job 的信息，请参阅 [[00-Job System]]。
...
- **Static method**：对方法及其父类型应用 `[BurstCompile]`。要使用根据其他数据状态处理数据的动态函数，请参阅 [[03-函数指针]]。
