...
| [[00-CSharp语言支持]] | 查看 C# 语言中属于 Burst 可编译的高性能 C# 子集的元素。 |
| [[00-配置Burst编译]] | 定义 Burst 在不同上下文中编译的内容和方式，标记代码进行 Burst 编译，并配置编译过程的各个方面；其中包括 [[05-Play Mode中的Burst编译]]。 |
| [[00-Burst Intrinsics]] | 如果编写单指令、多数据（SIMD）汇编代码，使用底层 Intrinsics 从 Burst 中获得额外性能。 |
...
| [[00-Burst优化]] | 通过调试和性能分析识别 Burst 编译代码中的错误或瓶颈，并配置各种选项来优化性能。 |
