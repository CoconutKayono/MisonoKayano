...
有关应在何处以及何时应用 `[BurstCompile]` attribute 的信息，请参阅 [[01-标记代码进行Burst编译]]。
...
有关如何从 C# 代码调用这个 Burst 编译的 utility class 及其成员方法，请参阅 [[02-调用Burst编译代码]]。

## 限制

Burst 支持大多数 C# expressions 和 statements，但有少数例外。更多信息请参阅 [[00-CSharp语言支持]]。
