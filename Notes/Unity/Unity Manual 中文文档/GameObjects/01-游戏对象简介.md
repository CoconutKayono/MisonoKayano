...
![四种不同类型的 GameObject：动画角色、Light、树木和音频源](GameObjectsExamples.jpg)
...
![带有多个 Components 的简单 Light GameObject](GameObjectLightExample1.png)

实体 Cube 对象使用 `Mesh Filter` 和 `Mesh Renderer` Component 绘制 Cube 表面，并使用 `Box Collider` Component 在 Physics 中表示对象的实体体积。

![带有多个 Components 的简单 Cube GameObject](GameObjectCubeExample1.png)
...
- [[02-Transform组件|Transform]]
- [[01-组件简介|组件简介]]
- [[02-使用组件|使用组件]]
- [[05-原始体和占位对象|原始体和占位对象]]
- [[03-使用脚本创建组件|使用脚本创建组件]]
- [[04-停用游戏对象|停用 GameObject]]
- [[05-将标签分配给游戏对象]]
- [[03-静态游戏对象|静态 GameObject]]
- [[00-预制件|Prefab]]
