...
![以 Isolation 模式打开 Prefab Editing Mode 时的 Scene 视图和 Hierarchy。Prefab Breadcrumb Bar 已高亮。](prefabs-isolation-mode.png)
...
![以 Context 模式打开 Prefab Editing Mode，Context 设置为 Gray 时的 Scene 视图和 Hierarchy。Prefab 选项已高亮。](prefab-mode-context-grey.png)
