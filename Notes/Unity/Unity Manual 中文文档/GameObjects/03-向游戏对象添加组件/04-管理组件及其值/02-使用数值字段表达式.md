...
![使用 L(-10,10) 将选中的 Capsule 沿 X 轴从 -10 到 10 均匀分布](inspector-expr-L.png)
...
![使用 /=3 将上一个示例中的随机值除以三](inspector-expr-assign.png)
...
![使用 cos(L(0,2*pi))*5 作为 X 值、sin(L(0,2*pi))*5 作为 Z 值创建的圆形](inspector-expr-trig.png)
