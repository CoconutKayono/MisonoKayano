...
![Gradient Editor：包含三个不同颜色的颜色停止点，以及三个 Alpha 停止点。](inspector-gradient-editor.png)
...
![颜色插值在绿色标记处停止，标记右侧全部为纯色。](InterpolationStartingFromSolid.png)
...
![Classic Gradient 模式。](GradientEditorModeBlend.png)

![Perceptual blend Gradient 模式。](GradientEditorModePerceptual.png)

![Fixed Gradient 模式。](GradientEditorModeFixed.png)
