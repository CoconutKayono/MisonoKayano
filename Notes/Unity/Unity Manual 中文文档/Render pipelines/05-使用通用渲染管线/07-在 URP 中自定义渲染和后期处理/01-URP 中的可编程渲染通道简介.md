...
您可以通过将可编程渲染通道注入渲染管线来实现自定义的视觉效果。有关详细信息，请参阅[[00-在 URP 中将可编程渲染通道添加到帧渲染循环]]。
...
在 URP 渲染循环的某些特定点，Unity 会注入可编程渲染通道。这些特定点被称为注入点。通过更改注入点，您可以控制可编程渲染通道对场景外观的影响。有关注入点的更多信息，请参阅[[04-URP 的注入点参考]]。

## 其他资源

- [[00-通过 URP 中的渲染器功能添加预构建效果]]
