...
[[01-在 URP 中创建可编程渲染器功能]]后，请将**要使用的材质 (Material To Use)** 参数设置为任何材质。
...
有关另一个示例，请参阅[[03-在 URP 中导入包示例]]中名为 **RendererList** 的示例。

## 其他资源

- [[00-URP 中的 Render Graph 系统中的纹理]]
- [[01-从 URP 中的当前帧获取数据]]
