...
要为自定义渲染通道创建代码，需编写一个继承 `ScriptableRenderPass` 的类。在此类中，使用[[01-URP 中的渲染图系统简介]] 来告知 Unity 要使用哪些纹理和渲染目标以及要对它们执行哪些操作。
...
请参阅[[01-在 URP 中创建可编程渲染器功能]]了解更多信息。
...
请参阅[[02-在 URP 中通过脚本注入渲染通道]]了解更多信息。
...
- 上一页：[[03-URP 的渲染对象渲染器功能 (Render Objects Renderer Feature) 参考]]
