...
每个示例都使用自己的 [[01-URP 通用渲染管线资源参考]]。如果要构建示例场景，请将示例的 URP 资源添加到 Graphics 设置中；否则 Unity 可能会剥离示例使用的着色器或渲染通道。
...
`URP Package Samples/RendererFeatures` 文件夹包含 [[01-向 URP 渲染器添加渲染器功能]] 示例。
