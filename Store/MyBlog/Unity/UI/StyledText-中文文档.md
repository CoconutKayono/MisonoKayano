...
![粗体富文本效果](images/StyleTextBold.png)
...
![粗体与斜体嵌套效果 1](images/StyleTextBoldItalic1.png)
...
![粗体与斜体嵌套效果 2](images/StyleTextBoldItalic2.png)
...
![绿色富文本效果](images/StyleTextColorGreen.png)
...
| 颜色名 | 十六进制值 | 色板 |
| --- | --- | --- |
| `aqua`（同 `cyan`） | `#00ffffff` | ![cyan](images/CyanSwatch.png) |
| `black` | `#000000ff` | ![black](images/BlackSwatch.png) |
| `blue` | `#0000ffff` | ![blue](images/BlueSwatch.png) |
| `brown` | `#a52a2aff` | ![brown](images/BrownSwatch.png) |
| `cyan`（同 `aqua`） | `#00ffffff` | ![cyan](images/CyanSwatch.png) |
| `darkblue` | `#0000a0ff` | ![darkblue](images/DarkblueSwatch.png) |
| `fuchsia`（同 `magenta`） | `#ff00ffff` | ![magenta](images/MagentaSwatch.png) |
| `green` | `#008000ff` | ![green](images/GreenSwatch.png) |
| `grey` | `#808080ff` | ![grey](images/GreySwatch.png) |
| `lightblue` | `#add8e6ff` | ![lightblue](images/LightblueSwatch.png) |
| `lime` | `#00ff00ff` | ![lime](images/LimeSwatch.png) |
| `magenta`（同 `fuchsia`） | `#ff00ffff` | ![magenta](images/MagentaSwatch.png) |
| `maroon` | `#800000ff` | ![maroon](images/MaroonSwatch.png) |
| `navy` | `#000080ff` | ![navy](images/NavySwatch.png) |
| `olive` | `#808000ff` | ![olive](images/OliveSwatch.png) |
| `orange` | `#ffa500ff` | ![orange](images/OrangeSwatch.png) |
| `purple` | `#800080ff` | ![purple](images/PurpleSwatch.png) |
| `red` | `#ff0000ff` | ![red](images/RedSwatch.png) |
| `silver` | `#c0c0c0ff` | ![silver](images/SilverSwatch.png) |
| `teal` | `#008080ff` | ![teal](images/TealSwatch.png) |
| `white` | `#ffffffff` | ![white](images/WhiteSwatch.png) |
| `yellow` | `#ffff00ff` | ![yellow](images/YellowSwatch.png) |
